...
Bug fixes and documentation improvements are welcome! If you want to contribute, have a look at our [issue tracker](https://github.com/undertow-io/spring-boot-undertow/issues "spring-boot-undertow Issues") and get in touch with us via [Zulip chat](https://wildfly.zulipchat.com/#narrow/stream/174183-undertow "#undertow").


PRs must be submitted to the main branch and they should:
- state clearly what they do (see more [here](https://tbaggery.com/2008/04/19/a-note-about-git-commit-messages.html))
- point to associated issue (see more [here](#Issues))
...
spring-boot-undertow uses GitHub Issues to manage issues. All issues can be found [here](https://github.com/undertow-io/spring-boot-undertow/issues).

## Good First Issues

Want to contribute to spring-boot-undertow but aren't quite sure where to start? Check out our issues with the `good first issue` label. These are a triaged set of issues that are great for getting started on our project. These can be found [here](https://github.com/undertow-io/spring-boot-undertow/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22).

Once you have selected an issue you would like to work on, make sure it's not already assigned to someone else.

## Discussing your Planned Changes

If you want feedback, you can discuss your planned changes in any of the following ways: 
* add comments to the issue ticket at [spring-boot-undertow Issues](https://github.com/undertow-io/spring-boot-undertow/issues)
...
- is the proposed fix the best approach for the issue at hand?
- backwards compatibility: we must prevent any PR that breaks compatibility with previous versions. If the PR does so, it could still be okay, but this should be clearly documented and it will probably be discussed by the project maintainers before being merged
...
spring-boot-undertow. Regardless of your level of experience, though, we kindly ask you that PRs are always rebased before being submitted or
updated.
...
### Fork spring-boot-undertow

Fork https://github.com/undertow-io/spring-boot-undertow into your GitHub account.

### Clone your newly forked repository onto your local machine

```bash
git clone git@github.com:[your username]/spring-boot-undertow.git
...
```bash
git remote add upstream git://github.com/undertow-io/spring-boot-undertow.git
```

## Development Process

This is the typical process you would follow to submit any changes to spring-boot-undertow.
...
```bash
git push origin --force my_cool_feature
```
